...
<div class="container" id="page">
	...
	<div id="header">
		<div id="logo"><?php echo CHtml::encode(Yii::t('default', Yii::app()->name)); ?></div>
	</div><!-- header -->

	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				array('label'=>'домашня', 'url'=>array('/notes/index')),
				array('label'=>'регістрація', 'url'=>array('/users/create')),
